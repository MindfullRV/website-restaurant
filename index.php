    ...
    <body>
        ...
        <div class="wrapper">
            ...
            <header class="bg-transparent">
                ...
                <nav>
                    <img class="menu" src="assets/svg/close.svg" alt="icon">
                    <ul>
                ...
                <img class="menu" src="assets/svg/menu.svg" alt="icon">
            </header>
            <!-- Headline section -->
            <section id="hero">
                <div class="container">
            ...
            <section id="contact">
                <div class="container">
                    <div class="left">
                        ...
                        <div class="detail">
                            <div class="add">
                                <img src="assets/svg/address.svg" alt="Icon">
                                <h4>Address</h4>
                            ...
                            <div class="add">
                                <img src="assets/svg/email.svg" alt="Icon">
                                <div>
                                    <h4>Email</h4>
                            ...
                            <div class="socmed">
                                ...
                                <a href="instagram.com">
                                    <img src="assets/svg/instagram.svg" alt="Icon">
                                </a>
                                <a href="twitter.com">
                                    <img src="assets/svg/twitter.svg" alt="Icon">
                                </a>
                            </div>
                        </div>
                    </div>
